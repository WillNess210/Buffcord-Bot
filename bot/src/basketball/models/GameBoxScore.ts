...
export const createTeamPlayerScore = (data: any): BBPlayerBoxScore => {
    ...
    return {
        ...
        field_goals_made: statistics.field_goals_made || 0,
        field_goals_att: statistics.field_goats_att || 0,
        field_goals_pct: statistics.field_goals_pct || 0,
        three_points_made: statistics.three_points_made || 0,
        three_points_att: statistics.three_points_att || 0,
        three_points_pct: statistics.three_points_pct || 0,
        free_throws_made: statistics.free_throws_made || 0,
        free_throws_att: statistics.free_throws_att || 0,
        free_throws_pct: statistics.free_throws_pct || 0,
        ...
        personal_fouls: statistics.personal_fouls || 0,
